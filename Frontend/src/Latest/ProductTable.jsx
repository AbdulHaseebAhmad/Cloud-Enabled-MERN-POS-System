...
import { deleteProduct, getProducts } from "../InventoryManagement/Redux/Product/ProductActions";
import { useDispatch,useSelector } from "react-redux";
import "../InventoryManagement/StockTracking/RestockPipeline.css"; // Custom styles for AG Grid
...
export default function ProductTable() {
  ...
  const [colDefs] = useState([
    ...
    { field: "Actions", cellRenderer: ()=><span className="flex gap-2 pt-1 pb-1"><button
