...
export default function AddVariant({handleChange,removeVariant,handleSubmit,variants}) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
          {variants.map((variant, index) => (
            ...
            >
             ...
             {(index === variants.length - 1)&& ( <button
                type="button"
...
AddVariant.propTypes = {
    ...
    variants: PropTypes.arrayOf(
      PropTypes.shape({
        ...
        value: PropTypes.string.isRequired, // Value of the variant (e.g., "Red", "Large")
      })
