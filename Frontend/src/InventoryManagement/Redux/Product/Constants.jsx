const ADD_PRODUCT = "Adding Product";
const ADD_PRODUCT_SUCCESS = "Product Added Successfully";
const ADD_PRODUCT_FAILURE = "Product Addition Failed";

const UPDATE_PRODUCT = "Updating Product";
const UPDATE_PRODUCT_SUCCESS = "Product Updated Successfully";
const UPDATE_PRODUCT_FAILURE = "Product Updation Failed";

const DELETE_PRODUCT = "Deleting Product";
const DELETE_PRODUCT_SUCCESS = "Product Deleted Successfully";
const DELETE_PRODUCT_FAILURE = "Product Deletion Failed";

const FETCH_PRODUCTS = "Fetching Products";
const FETCH_PRODUCTS_SUCCESS = "Products Fetched Successfully";
const FETCH_PRODUCTS_FAILURE = "Products Fetching Failed";

const FETCH_PRODUCT = "Fetching Product";
const FETCH_PRODUCT_SUCCESS = "Product Fetched Successfully";
const FETCH_PRODUCT_FAILURE = "Product Fetching Failed";
